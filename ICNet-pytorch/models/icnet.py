...
__all__ = ['ICNet', 'get_icnet', 'get_icnet_resnet50_citys', 'get_icnet_resnet101_citys', 'get_icnet_resnet152_citys']
...
# The following codes are excerpted from URL, https://github.com/liminn/ICNet-pytorch/blob/master/models/icnet.py
